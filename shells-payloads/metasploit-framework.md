...
| **Name**    | Specific action/exploit     | scriptftp\_list |
...
| ------------------ | -------------------------------- | ------------------ |
| **reverse\_tcp**   | Target connects back to attacker | Bypasses firewalls |
| **bind\_tcp**      | Attacker connects to target      | Direct connection  |
| **reverse\_https** | HTTPS tunnel for stealth         | Evades detection   |
...
* **snake\_case**: Use underscores, not dashes
